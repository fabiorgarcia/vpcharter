  ...
  function validaFormModal() {
    ...
    .then(response=> {
      if (response.data.length > 0) {
        ...
        setTypeAlert('alert-success')
        settitleAlert('Alterado com sucesso!')
        setTxtAlert('Fretamento alterado!')
        //carregaPagina()
        setTimeout(()=> setAlert(false),5000);
        setTimeout(()=> navigate('/fretamento'),5000);
      } else {
        setAlert(true)
        setTypeAlert('alert-danger')
  ...
  return (
    ...
    <div className='allTab'>
      ...
      <div className='content'>
        ...
        <div className='breadCrumb'><Link to="/home" relative="path"><MdOutlineHome className='icoBread' /><BiSolidChevronRight className='caretRight' />  Home</Link>&nbsp;/&nbsp;<Link to="/aereo" relative="path">Aéreo</Link>&nbsp;/&nbsp;<Link to="/aereo/fretamento" relative="path">Fretamento</Link>&nbsp; / Edita Fretamento</div>

          <div className="row">
            <div className="col-12">
              <h1>Edita Fretamento</h1>
            </div>
          </div>
