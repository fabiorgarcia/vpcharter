...
function Assentos() {
  ...
  const [masterTitle, setMasterTitle] = useState ('Características dos Assentos');
  ...
  function validaForm(e) {
    ...
    setTimeout(function() {
      if (!newData) {
        var query = "UPDATE `vpcharter_caracteristicasassentos` SET `caracteristica` = '"+caracteristica.trim()+"' WHERE `vpcharter_caracteristicasassentos`.`id` = '"+idData+"';";
        var fData = new FormData();
        fData.append('query', query);
        axios.post(endpoint+'query.php', fData)
        .then(response=> {
        ...
        var query = "SELECT * FROM `vpcharter_caracteristicasassentos` WHERE `id` = '"+idData+"' ";
        var fData = new FormData();
        fData.append('query', query);
        axios.post(endpoint+'query.php', fData)
        .then(response=> {
          if (response.data.length > 0) {
            ...
            var query = "INSERT INTO `vpcharter_caracteristicasassentos` (`id`, `caracteristica`) VALUES (NULL, '"+caracteristica+"') ";
            var fData = new FormData();
            fData.append('query', query);
            axios.post(endpoint+'query.php', fData)
            .then(response=> {
  ...
  function listSearch() {
    ...
    setTypeAlert('')
    setIdData('')
    var query = "SELECT * FROM `vpcharter_caracteristicasassentos` WHERE `caracteristica` LIKE '%"+buscaFiltro+"%' ORDER BY `caracteristica` ";
    var fData = new FormData();
    fData.append('query', query);
    axios.post(endpoint+'query.php', fData)
    .then(response=> {
